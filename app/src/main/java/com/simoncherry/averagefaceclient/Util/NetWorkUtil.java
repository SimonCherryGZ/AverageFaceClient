package com.simoncherry.averagefaceclient.Util;
...
public class NetWorkUtil {
    ...
    // ===================================
    public static String sendMergeCommand(String urlPath,
                                          String path, String encoding) throws Exception {

        String res = "null";
        String str = urlPath + "?path=" + path;
        // 打开链接
        URL url = new URL(str);
        HttpURLConnection conn = (HttpURLConnection) url.openConnection();
        conn.setRequestMethod("GET");
...
//			return responseData;
    ...
    public static String sendRequest(String urlPath,
                                     String req, String dat, String encoding) throws Exception {

        String res = "null";
        String str = urlPath + "?request=" + req + "&data=" + dat;
        // 打开链接
        URL url = new URL(str);
        HttpURLConnection conn = (HttpURLConnection) url.openConnection();
        conn.setRequestMethod("GET");
